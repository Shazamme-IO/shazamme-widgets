 ...
 * Build 732656f75a8e. Registers window.ShazammeWidget["<name>"].
 */
var __shazWidgetExport=(()=>{var V=Object.defineProperty;var pe=Object.getOwnPropertyDescriptor;var ge=Object.getOwnPropertyNames;var Ie=Object.prototype.hasOwnProperty;var De=(D,t)=>{for(var f in t)V(D,f,{get:t[f],enumerable:!0})},Qe=(D,t,f,i)=>{if(t&&typeof t=="object"||typeof t=="function")for(let l of ge(t))!Ie.call(D,l)&&l!==f&&V(D,l,{get:()=>t[l],enumerable:!(i=pe(t,l))||i.enumerable});return D};var Oe=D=>Qe(V({},"__esModule",{value:!0}),D);var Te={};De(Te,{default:()=>ae});var he="https://sdk.shazamme.io/js/shazamme-1.0.3.min.js",me=/shazamme(-1\.0\.\d+(-test)?)?\.min\.js/;function se(D){return new Promise((t,f)=>{let i=document.createElement("script");i.src=D,i.onload=()=>t(),i.onerror=()=>f(new Error(`Failed to load ${D}`)),(document.head||document.documentElement).appendChild(i)})}function ve(){if(window.__shazSDKPromise)return window.__shazSDKPromise;let D=window.shazamme?Promise.resolve():se(he);return window.__shazSDKPromise=D,D}function ye(D){let t=window.__shazScriptCache=window.__shazScriptCache||{},f=t[D];if(f)return f;let i=se(D).catch(l=>{throw delete t[D],l});return t[D]=i,i}function we(){typeof window=="undefined"||window.__shazLoadScript||(window.__shazLoadScript=D=>me.test(D)?ve():ye(D))}function oe(){we()}function ae(D){oe();var t=D.data,f=D.element,i=D.$||window.jQuery||window.$,l=D.shazamme||window.shazamme;let A=new re,S={},Se=!1,Pe=!1,C=t.siteId,ke={},E="thank-you",j="dashboard",xe="register",B;t.config.toggleThankyouPage&&(E=t.config.txt_Thankyoupageurl);let k=t.config.showResume===!0,_=t.config.applicationLayout!=="simpleForm"&&t.config.showCoverLetter,z=t.config.showSubscription==="true",F=new URL(window.location.href),N=!1,M=document.getElementById("passwordInput"),Z={submit:"application-screening-form-submit"},H=(parseInt(t.config.maxUploadSize)||10)*1024*1024;if(t.config.showScreeningQuestions&&Y(),i("#passwordInput").focus(function(){i("#passwordMessage,.arrow-bottom").css("display","flex")}),i("#passwordInput").blur(function(){N&&i("#passwordMessage, .arrow-bottom").css("display","none")}),t.config.useSmartLogin&&!ce()){var q=null;i(f).find(".smart-login-login, .smart-login-register").hide(),i("#emailLogin").keyup(function(){q&&clearTimeout(q),q=setTimeout(()=>{let s=i(this).val().trim();if(s.length===0){i(f).find(".smart-login-login, .smart-login-register").hide();return}firebase.auth().fetchSignInMethodsForEmail(s).then(c=>{i(f).find(".smart-login-login, .smart-login-register").hide(),c.length>0?i(f).find(".smart-login-login").show():(i(f).find(".smart-login-register").show(),i("#emailAddress").val(s))}).catch(()=>{i(f).find(".smart-login-login").hide(),i(f).find(".smart-login-register").show()}),q=null},500)})}if(M){let s=document.getElementById("capital"),c=document.getElementById("number"),a=document.getElementById("length"),n=document.getElementById("specialChar");M.onkeyup=function(){let o=0;if(M.value.length<8?(a.classList.remove("valid"),a.classList.add("invalid"),o-=1):(a.classList.remove("invalid"),a.classList.add("valid"),o+=1),M.value.search(/(?=.*[A-Z])/)!=-1?(s.classList.remove("invalid"),s.classList.add("valid"),status=!0,o+=1):(s.classList.remove("valid"),s.classList.add("invalid"),o-=1),M.value.search(/\d/)!=-1?(c.classList.remove("invalid"),c.classList.add("valid"),o+=1):(c.classList.remove("valid"),c.classList.add("invalid"),o-=1),M.value.search(/(?=.*[!@#$%^&*])/)!=-1?(n.classList.remove("invalid"),n.classList.add("valid"),o+=1):(n.classList.remove("valid"),n.classList.add("invalid"),o-=1),o===4){i(".passwordErrorTitle").text("Your password is acceptable!"),i("#passwordMessage").css("background-color","#59db5d"),i(".valid,.passwordErrorTitle").css("color","#fff"),i(".arrow-bottom").css({"border-top":"15px solid #59db5d"}),N=!0;return}else return i(".passwordErrorTitle").text("Password must contain the following"),i("#passwordMessage").css("background-color","#ffa1a1"),i("#passwordMessage,.passwordErrorTitle, .invalid").css("color","red"),i(".arrow-bottom").css({"border-top":"15px solid #ffa1a1"}),N=!1,!1}}function U(s,c){var a=s.files[0];let n=a.name.replace(/[^a-z0-9-_.]/gi,"-").replace(/-{2,}/gi,"-");var o=new FileReader;let e=c=="resume"?"resumeFile":"coverLetterFile",r=c=="resume"?"resumeName":"coverLetterFileName";o.addEventListener("load",function(){S[e]=o.result,S[r]=n},!1),a&&o.readAsBinaryString(a)}i(f).find("input#resume").on("change",function(){var n;let s=this;if(((n=s.files[0])==null?void 0:n.size)>H){alert(t.config.resumeSizeWarning||`Error! File too large, Should not exceed ${t.config.maxUploadSize||""}mb`),i(s).val("");return}let a=i("input[type=radio][name=uploadTypeResume][value=uploadResume]");a.get(0).checked=!0,a.trigger("change"),U(s,"resume")}).each(function(){var n;let s=this,c=(n=s.files[0])==null?void 0:n.size;if(s.files.length==0)return;if(c>H){alert(t.config.resumeSizeWarning||`Error! File too large, Should not exceed ${t.config.maxUploadSize||""}mb`),i(s).val("");return}let a=i("input[type=radio][name=uploadTypeResume][value=uploadResume]");a.get(0).checked=!0,a.trigger("change"),U(s,"resume")}),i(f).find("input#cover").on("change",function(){var n;let s=this;if(((n=s.files[0])==null?void 0:n.size)>H){alert(t.config.resumeSizeWarning||`Error! File too large, Should not exceed ${t.config.maxUploadSize||""}mb`),i(s).val("");return}let a=i("input[type=radio][name=uploadTypeCover][value=uploadCover]");a.get(0).checked=!0,a.trigger("change"),U(s,"cover")}).each(function(){var n;let s=this,c=(n=s.files[0])==null?void 0:n.size;if(s.files.length==0)return;if(c>H){alert(t.config.resumeSizeWarning||`Error! File too large, Should not exceed ${t.config.maxUploadSize||""}mb`),i(s).val("");return}let a=i("input[type=radio][name=uploadTypeCover][value=uploadCover]");a.get(0).checked=!0,a.trigger("change"),U(s,"cover")}),i("input[type=radio][name=uploadTypeResume]").change(function(){this.value=="uploadResume"?(i(".fileUploadContainer").css("display","flex"),k=!0):(i(".fileUploadContainer").css("display","none"),k=!1)}),i("input[type=radio][name=uploadTypeCover]").on("change",function(){this.value=="uploadCover"?(i(".coverUploadContainer").css("display","flex"),_=!0):(i(".coverUploadContainer").css("display","none"),_=!1)}).first().attr("checked","checked").trigger("change"),i("#loginBtn").click(function(){let s=i("#emailLogin").val(),c=i("#passwordLogin").val();B="loginForm",A.nativeLogin(s,c)}),i(".container-item").click(function(){switch(i(".registerTxt").hide(),i(this).attr("data-provider")){case"facebook":{A.loginOrRegisterUsingProvider(facebookProvider);break}case"google":{A.loginOrRegisterUsingProvider(googleProvider);break}case"linkedin":{l.oauth("linkedinProvider");break}case"seek":{l.oauth("seekProvider");break}}});function W(s,c,a){if(c){let n=a=="resume"?t.config.warningResume||"Please upload your resume":t.config.warningCoverLetter||`Please upload your cover letter, or tick the "I don't have cover letter"`;if(s.files[0]==null){throw w("stop"),i(s).find(".fcLoader").removeClass("fcLoadingSeek"),alert(n),new Error(n);return null}return s.files[0]}return null}function Ce(s,c){s&&(S[c]=s)}function re(){this.clearKeys=()=>{let s=["seekAuthorizationCode","authProvider","currentJobViewed","linkedIncode","jobID"];for(let c of s)l.store(c,null)},this.nativeLogin=(s,c)=>{l.firebase().auth(s,c).then(()=>{if(t.inEditor)return;if(B=="loginForm"){window.location.reload();return}if(B=="registrationForm"){let n=window.location.href.includes(C)?`/site/${C}/${E}?preview=true&insitepreview=true&dm_device=desktop`:`/${E}`;window.location.href=n;return}let a=l.store("previousApplicationPage");if(a){window.location.href=a;return}window.location.href=window.location.href.includes(C)?`/site/${C}/${E}?preview=true&insitepreview=true&dm_device=desktop`:`/${E}`}).catch(a=>{alert(a.msg)})},this.loginOrRegisterUsingProvider=s=>{l.firebase().oauth(s).then(c=>{c.isNew?l.submit({action:"Register Candidate",salutation:" ",firstName:c.firstName,surname:c.lastName,eMail:c.email,password:l.uuid(),candidateID:l.uuid(),firebaseUserID:c.firebaseUserID,isActive:!0,isValidated:!0,isSubscribed:z&&i(f).find("[data-rel=checkbox-subscribe]:checked").length>0,dudaSiteID:t.siteId}).then(a=>{a.status&&!t.inEditor&&l.auth(c.email,c.firebaseUserID,!0).then(()=>{window.location.reload()})}):window.location.reload()}).catch(c=>{alert(c.msg)})}}function J(s){let c=i(f);s?(c.find("#salutation").val(s.salutation||""),c.find("#firstName").val(s.firstName||""),c.find("#lastName").val(s.surname||""),c.find("#emailAddress").val(s.eMail||"").attr("readonly","readonly"),c.find("#phoneNumber").val(s.phone||""),c.find("#mobileNumber").val(s.mobile||""),s.isNew?(c.find(".shmLoginContainer,.applyMainSocial,.subscriptionContainer").show(),c.find(".greeting-message").hide()):(c.find(".shmLoginContainer,.applyMainSocial,.subscriptionContainer").hide(),c.find(".greeting-message").show().text(`${t.config.greeting||"Welcome back"} ${s.firstName||""} ${s.surname||""}!`))):(c.find(".shmregistrationContainer,.shmLoginContainer,.applyMainSocial,.subscriptionContainer").show(),c.find(".greeting-message").hide().text(""),c.find("#salutation").val(""),c.find("#firstName").val(""),c.find("#lastName").val(""),c.find("#emailAddress").val("").removeAttr("readonly"),c.find("#phoneNumber").val(""),c.find("#mobileNumber").val("")),t.inEditor&&c.find(".greeting-message").show().text(`${t.config.greeting||"Welcome back"}!`),s!=null&&s.cVFileContent||i(f).find(".uploadExisting").css("display","none"),t.config.showScreeningQuestions&&Y()}function ce(){return window.localStorage.vinylResponse}function x(){return new URL(window.location.href).searchParams.get("jobID")||t.config.useSingleJob&&t.config.jobID||l.store("jobID")}function G(s){typeof s!="object"&&console.warn("not object by objectChecker");for(let c in s)if(s[c]==="")return!1;return!0}function w(s){if(s=="apply"){i(".submitApplicationBtn, .applyText").css("pointer-events","none");return}i(".submitApplicationBtn, .applyText").css("pointer-events","auto"),i(".applyText").show()}function Y(){let s=x();l.site().then(c=>l.fetch({path:`/job-results/${c.siteID}/${x()}`,isExternal:!0,useCache:!0})).then(c=>{var a;(a=c==null?void 0:c.data)!=null&&a.screeningTemplateID&&l.submit({action:"Get Screening Questions",templateID:c.data.screeningTemplateID}).then(n=>{if(!n.status)return;let o=n.response.map(e=>de(e));i(f).find("[data-rel=screening-fields]").empty().append(o)})})}function de(s){var c,a;switch(s.questionType){case"Text":return`
        ...
        `)),new Promise(e=>{new Promise((u,d)=>{if(t.inEditor&&!o){u(JSON.parse(a._mock));return}dmAPI.loadCollectionsAPI().then(b=>{b.data("Jobs").where("jobID","EQ",o).get().then(g=>{let p=g.values.length>0&&g.values[0].data.screeningTemplateID;p?(a._screeningTemplateID=p,b.data("Screening Questions").where("screeningTemplateID","EQ",p).get().then(v=>{u({response:{items:v.values.map(y=>y.data)}})},v=>{d(v)})):u({})})})}).then(u=>{if(!u||!u.response||!u.response.items||u.response.items.length==0){e();return}u.response.items.forEach(d=>{pIndex=Math.floor((parseInt(d.sortOrder)||0)/100),a._pages[pIndex]=a._pages[pIndex]||[],a._pages[pIndex].push(d)});for(let d=0;d<a._pages.length;d++)a._pages[d]||a._pages.splice(d,1);a._ko=u.response.items.filter(d=>d.knockOutDate||d.knockOutList||d.knockOutText||d.knockOutNumber||d.knockOutBoolean!==null),e()})})},this._showQuestions=(n,o=!0)=>{if(n>this.pageNumber&&!this._validate()){alert("Please answer all questions");return}this._recordAnswers().then(()=>{var d;n>this._maxPage&&(this._maxPage=n);let e=i(f).find("[data-rel=screening-fields]"),r=(this._pages[n]||[]).filter(b=>!b.parentQuestionID||a._answers[b.parentQuestionID]),u=r.map(b=>{var g;return a._questionElement({...b,options:(g=b.options)==null?void 0:g.filter(p=>{var v;return!b.parentQuestionID||((v=a._answers[b.parentQuestionID].answerUUID)==null?void 0:v.indexOf(p.parentOptionID))>=0})})});e.empty().append(u).append(a._pagingElements(n)),e.find(".sq-help-text[collapsible]").each(function(b,g){let p=i(g),v=i(p).outerHeight();p.find(".text-main").attr("style",`--shaz-help-text-lines: ${t.config.helpTextLines||3}`),p.outerHeight()<v&&p.addClass("collapsible").on("click","[data-rel=button-show-more]",function(){let y=i(this);p.hasClass("expanded")?(p.find(".text-main").css({display:"-webkit-box"}),p.removeClass("expanded")):(p.find(".text-main").css({display:"block"}),p.addClass("expanded"))})}),e.find("[data-rel=screening-page-index]").click(function(){let b=parseInt(i(this).attr("data-page"))||0;a._showQuestions(b)}),(d=this._pages[n])!=null&&d.find(b=>b.parentQuestionID)&&e.find("input, select").on("change",function(){i(this).is("[data-qtype=date]")||a._recordAnswers().then(()=>{a._showQuestions(n,!1)})}),e.find("[data-rel=screening-apply]").click(function(){if(!a._validate()){alert("Please answer all questions");return}l.pub(Z.submit)}),o&&(e.get(0).scrollIntoView(),window.scrollBy({top:-200,behavior:"smooth"})),this._restoreAnswers(r.map(b=>b.screeningQuestionID)),this.pageNumber=n})},this._questionElement=n=>{var o,e,r,u,d,b,g,p,v,y,P,O,m,I;if(((o=n.parentQuestionID)==null?void 0:o.length)>0&&!(((e=n.options)==null?void 0:e.length)>0))return"";switch(n.questionType){case"Text":return`
                ...
                `;case"List":{let Q=(g=n.options)==null?void 0:g.map(h=>`<option value="${h.screeningQuestionOptionsID}">${h.label||h.option}</option>`);return`
                     <div class="input-field-container">
                ...
                `}case"Multiselect Checkbox":{let Q=(v=n.options)==null?void 0:v.map(h=>`<label><input tabindex="30" type="checkbox" autocomplete="nope" data-qtype="check-list" data-qid="${n.screeningQuestionID}" data-value="${h.screeningQuestionOptionsID}" ${n.isMandatory?"required":""} />${h.label||h.option}</label>`);return`
                     <div class="input-field-container">
                        <p class="sq-checklist-question">
                            ${n.question}
                            ${n.isMandatory?"*":""}
                        </p>
                        ${((y=n.helpText)==null?void 0:y.length)>0&&`
                        <div class="sq-help-text" ${n.isHelpTextCollapse?"collapsible":""}>
                            <p class="text-main">${n.helpText||""}</p>
                            <div class="section-read-more" style="text-align: ${t.config.readMoreAlign}">
                                <a href="javascript: void(0);" class="button-show-more" data-rel="button-show-more">${t.config.showMoreHelpText}</a>
                ...
                `}case"Radio":{let Q=(P=n.options)==null?void 0:P.map(h=>`<label class="sq-question-option"><input tabindex="30" type="radio" data-qtype="radio" name="${n.screeningQuestionID}" data-qid="${n.screeningQuestionID}" value="${h.screeningQuestionOptionsID}" ${n.isMandatory?"required":""} />${h.label||h.option}</label>`);return`
                     <div class="input-field-container">
                ...
                `}case"File":return`
                     <div class="input-field-container">
                        ...
                        ${((m=n.helpText)==null?void 0:m.length)>0&&`
                        <div class="sq-help-text" ${n.isHelpTextCollapse?"collapsible":""}>
                            <p class="text-main">${n.helpText||""}</p>
                            <div class="section-read-more" style="text-align: ${t.config.readMoreAlign}">
                                <a href="javascript: void(0);" class="button-show-more" data-rel="button-show-more">${t.config.showMoreHelpText}</a>
                ...
                `;default:return""}},this._pagingElements=n=>{let o=[];if(o.push(`<div data-rel="screening-pages" class="screening-pages-container" style="--shaz-text-align: ${t.config.PagingButtonAlignment}">`),n>0&&o.push(`<a href='javascript:void(0);' class="button-page-nav back" data-rel='screening-page-index' data-page='${n-1}'><span class="text">${t.config.pageBack||"Back"}</span></a>`),n<this._pages.length-1?o.push(`<a href='javascript:void(0);' class="button-page-nav forward" data-rel='screening-page-index' data-page='${n+1}'><span class="text">${t.config.pageNext||"Next"}</span></a>`):o.push(`<a href='javascript:void(0);' class="button-page-nav forward" data-rel='screening-apply'><span class="text">${t.config.applyTextBtn||"Apply"}</span></a>`),this._pages.length>1){let e=new Array(this._maxPage+1);for(let r=0;r<e.length;r++)e[r]=`<a href='javascript:void(0);' class="button-page-index ${r===n?"active":""}" data-rel='screening-page-index' data-page='${r}'></a>`;for(let r=e.length;r<this._pages.length;r++)e[r]=`<a href='javascript:void(0);' class="button-page-index disabled"></a>`;o.push(`<div class="sq-pages-index">${e.join("")}</div>`)}return o.push("</div>"),o.join("")},this._presentList=n=>{let o=n.map(r=>`
            <div>
        ...
        `;i(e).appendTo(i(f))},this._recordAnswers=()=>Promise.all(i(f).find("[data-rel=screening-fields] input, [data-rel=screening-fields] select").map((n,o)=>{var r;let e=i(o);switch(e.attr("data-qtype")){case"text":return e.val()?a._answers[e.attr("data-qid")]={screeningQuestionID:e.attr("data-qid"),answerText:e.val(),screeningTemplateID:a._screeningTemplateID}:delete a._answers[e.attr("data-qid")],Promise.resolve();case"number":return e.val()?a._answers[e.attr("data-qid")]={screeningQuestionID:e.attr("data-qid"),answerNum:parseInt(e.val()),screeningTemplateID:a._screeningTemplateID}:delete a._answers[e.attr("data-qid")],Promise.resolve();case"date":return e.val()?a._answers[e.attr("data-qid")]={screeningQuestionID:e.attr("data-qid"),answerDate:e.val(),screeningTemplateID:a._screeningTemplateID}:delete a._answers[e.attr("data-qid")],Promise.resolve();case"bool":return a._answers[e.attr("data-qid")]={screeningQuestionID:e.attr("data-qid"),answerBoolean:e.is(":checked")?1:0,screeningTemplateID:a._screeningTemplateID},Promise.resolve();case"list":return e.val()?a._answers[e.attr("data-qid")]={screeningQuestionID:e.attr("data-qid"),answerUUID:[e.val()],screeningTemplateID:a._screeningTemplateID}:delete a._answers[e.attr("data-qid")],Promise.resolve();case"check-list":{let u=e.attr("data-qid"),d=((r=a._answers[u])==null?void 0:r.answerUUID)||[];return e.is(":checked")?d.indexOf(e.attr("data-value"))<0&&d.push(e.attr("data-value")):d.indexOf(e.attr("data-value"))>=0&&d.splice(d.indexOf(e.attr("data-value")),1),d.length===0?delete a._answers[e.attr("data-qid")]:a._answers[u]={screeningQuestionID:e.attr("data-qid"),answerUUID:d,screeningTemplateID:a._screeningTemplateID},Promise.resolve()}case"radio":return e.is(":checked")&&(a._answers[e.attr("data-qid")]={screeningQuestionID:e.attr("data-qid"),answerUUID:[e.attr("value")],screeningTemplateID:a._screeningTemplateID}),Promise.resolve();case"file":{let u=e.get(0).files.length>0&&e.get(0).files[0];return u?a._readFile(u).then(d=>(a._answers[e.attr("data-qid")]={screeningQuestionID:e.attr("data-qid"),answerFile:d,answerFileName:u.name,screeningTemplateID:a._screeningTemplateID},Promise.resolve())):(delete a._answers[e.attr("data-qid")],Promise.resolve())}default:return Promise.resolve()}})),this._restoreAnswers=n=>{for(let o in a._answers){let e=a._answers[o];if(o=o.split(":")[0],!(n.indexOf(o)<0)){if(i(f).find(`[data-rel=screening-fields] input[data-qid=${o}]:visible, [data-rel=screening-fields] select[data-qid=${o}]:visible`).length===0){delete a._answers[o];continue}e.answerText||e.answerNum||e.answerDate?i(f).find(`[data-rel=screening-fields] input[data-qid=${o}]`).val(e.answerText||e.answerNum||e.answerDate):e.answerBoolean&&!e.answerUUID?i(f).find(`[data-rel=screening-fields] input[data-qid=${o}]`).attr("checked",!0):e.answerUUID?(typeof e.answerUUID=="string"&&(e.answerUUID=e.answerUUID.split(",")),e.answerUUID.forEach(r=>{i(f).find(`[data-rel=screening-fields] input[data-qid=${o}][data-value=${r.trim()}]`).attr("checked",!0),i(f).find(`[data-rel=screening-fields] input[data-qid=${o}][value=${r.trim()}]`).attr("checked",!0),i(f).find(`[data-rel=screening-fields] select[data-qid=${o}]`).val(r.trim())})):e.answerFile&&i(f).find(`[data-rel=screening-fields] input[data-qid=${o}]`).val(this._fileBlob(e.answerFile))}}},this._validate=()=>{let n=!0;return i(f).find("[data-rel=screening-fields] input[required], [data-rel=screening-fields] select[required]").each((o,e)=>{let r=i(e);switch(r.attr("data-qtype")){case"text":case"select":{let u=r.val();n=n&&u&&u.trim().length>0;break}case"bool":{n=n&&r.is(":checked");break}case"number":{let u=r.val();n=n&&u&&u.trim().length>0&&!isNaN(u);break}case"date":{let u=Date.parse(r.val());n=n&&!isNaN(u);break}case"radio":{n=n&&i(f).find(`[data-rel=screening-fields] input[type=radio][name=${r.attr("name")}]`).is(":checked");break}case"file":{n=n&&r.get(0).files.length>0;break}case"check-list":n=n&&i(f).find(`[data-rel=screening-fields] input[data-qtype=check-list][data-qid=${r.attr("data-qid")}]`).is(":checked")}}),n},this._readFile=n=>new Promise(o=>{let e=new FileReader;e.addEventListener("load",()=>{o(btoa(e.result))},!1),e.readAsBinaryString(n)}),this._fileBlob=(n,o="",e=512)=>{let r=atob(n),u=[];for(let b=0;b<r.length;b+=e){let g=r.slice(b,b+e),p=new Array(g.length);for(let y=0;y<g.length;y++)p[y]=g.charCodeAt(y);let v=new Uint8Array(p);u.push(v)}return new Blob(u,{type:o})},this._showEditor=()=>{let n=e=>{var r,u;return e.knockOutDate?new Date(e.knockOutDate).toLocaleDateString():e.knockOutList?(u=(r=e.options)==null?void 0:r.find(d=>d.screeningQuestionOptionsID===e.knockOutList))==null?void 0:u.option:e.knockOutText?e.knockOutText:e.knockOutNumber?e.knockOutNumber:e.knockOutBoolean!==null?e.knockOutBoolean?"Yes":"No":""},o=e=>{var r,u;return`
        ...
        `};a._ko.length!==0&&s.config().then(e=>{let r=i(f).find("[data-dialog=knockout]");r.find("[data-rel=dialog-content]").empty().append(a._ko.map(d=>{var b;return o({...d,...(b=e==null?void 0:e.knockout)==null?void 0:b.find(g=>g.screeningQuestionID===d.screeningQuestionID)})})),i(f).find("[data-rel=screening-fields] .button-editor").remove(),i("<button />").text("Edit Knockout Handling").addClass("button-editor").on("click",function(){r.toggle()}).prependTo(i(f).find("[data-rel=screening-fields]"));let u=d=>{let b=i(d.target);i("<input />").attr({type:"checkbox","data-rel":"enable",checked:b.is(":checked")?"checked":null}).on("click",u).appendTo(b.parent()),b.remove()};r.find("[data-rel=enable]").on("click",u),r.find("[data-rel=button-submit]").on("click",function(){let d=(e==null?void 0:e.knockout)||[];r.find("[data-rel=dialog-content] article [data-rel=enable]").each((b,g)=>{let p=i(g).parents("article"),v=d.find(y=>y.screeningQuestionID===p.attr("data-id"));v&&d.splice(d.indexOf(v),1),i(g).is(":checked")&&d.push({screeningQuestionID:p.attr("data-id"),alert:p.find("[data-rel=alert]").val(),redirect:p.find("[data-rel=redirect]").val()})}),s.config().then(b=>s.config({...b,knockout:d})).then(()=>{e.knockout=d}),r.toggle()}),r.find("[data-rel=button-dismiss]").on("click",function(){r.toggle(),r.find("[data-rel=dialog-content]").empty().append(a._ko.map(d=>{var b;return o({...d,...(b=e==null?void 0:e.knockout)==null?void 0:b.find(g=>g.screeningQuestionID===d.screeningQuestionID)})})),r.find("[data-rel=enable]").on("click",u)})})},this._fetchAnswers=n=>l.site().then(o=>l.submit({action:"Get Screening Answers",siteID:o.siteID,jobApplicationID:n})).then(o=>{var r,u;let e=[];return(u=(r=o==null?void 0:o.response)==null?void 0:r.items)==null||u.forEach(d=>{e[d.screeningQuestionID]=d}),Promise.resolve(e)}),this._fetchQuestions().then(()=>{this._showQuestions(0,!1),t.inEditor&&this._showEditor()}),c&&this._fetchAnswers(c).then(n=>{let o=this._pages[0]||[];this._answers=n,this._restoreAnswers(o.map(e=>e.screeningQuestionID))}),this}let le=s=>{let c=ue(s,new URL(window.location).searchParams.get("jobApplicationID")),a=()=>{let e=n(),r=G(e),u=N;return r?k&&!e.cVFileContent?(alert(t.config.warningResume||"Please upload your resume"),Promise.reject()):u?l.firebase().validateEmail(e.eMail).then(()=>(e.candidateID=l.uuid(),t.config.showPassword||!t.config.useAnonymous?l.firebase().create(e.eMail,e.password).then(d=>Promise.resolve({...e,firebaseUserID:d.uid})).catch(d=>(w("hide"),i(f).find(".fcLoader").removeClass("fcLoadingSeek"),d.code==="auth/invalid-email"?alert(t.config.warningEmail||"Please use a valid email address"):d.code=="auth/email-already-in-use"&&t.config.showPassword&&window.confirm("The email is already an existing account please login instead.")&&(window.scrollTo({top:0,behavior:"smooth"}),i(f).find(".submitApplicationBtn").css("pointer-events","auto"),i(f).find(".applyText").show(),i(f).find(".fcLoader").removeClass("fcLoadingSeek")),Promise.reject(d))):Promise.resolve({...e,isValidated:!1}))).catch(()=>(w("hide"),i(f).find(".fcLoader").removeClass("fcLoadingSeek"),alert(t.config.warningEmail||"Please supply a valid email."),Promise.reject())):(w("hide"),i(f).find(".fcLoader").removeClass("fcLoadingSeek"),alert(t.config.warningPassword||"Please follow the password pattern!"),Promise.reject()):(w("hide"),alert(t.config.warningFields||"Please complete all required fields"),i(f).find(".fcLoader").removeClass("fcLoadingSeek"),Promise.reject())},n=()=>{var d,b,g,p,v,y,P;let e=i("#passwordInput").val()||"",r=i(f);t.config.showPassword||(e=l.uuid(),N=!0);let u={salutation:i(f).find("#salutation").val()||" ",firstName:((b=(d=r.find("#firstName").val())==null?void 0:d.trim())==null?void 0:b.replace(/["«»‘’‚‛“”„‟‹›❛❜❝❞❮❯〝〞〟＂❟❠⹂🙶🙷🙸＇]/g,""))||"",surname:((p=(g=r.find("#lastName").val())==null?void 0:g.trim())==null?void 0:p.replace(/["«»‘’‚‛“”„‟‹›❛❜❝❞❮❯〝〞〟＂❟❠⹂🙶🙷🙸＇]/g,""))||"",eMail:((v=r.find("#emailAddress").val())==null?void 0:v.trim())||"",phone:t.config.showPhoneNumber&&((y=r.find("#phoneNumber").val())==null?void 0:y.trim())||(t.config.requirePhone?"":void 0),mobile:t.config.showMobileNumber&&((P=r.find("#mobileNumber").val())==null?void 0:P.trim())||(t.config.requireMobile?"":void 0),password:e,isActive:!0,isValidated:!0,isSubscribed:z&&r.find("[data-rel=checkbox-subscribe]:checked").length>0,dudaSiteID:t.siteId,cVFileContent:S.resumeFile&&btoa(S.resumeFile),cVFileName:S.resumeName};return s&&t.config.enableTracing&&(!S.resumeFile||!S.coverLetterFile)&&(s.warn("file(s) missing",u),s.warn("file(s) missing (contains uploads)",S)),t.config.validatePhoneNumber&&(u.defaultPhoneCountry=t.config.defaultPhoneCountry||"AU",u.validatePhone=!0),u};s.sub(Z.submit,()=>{if(!x()){alert(t.config.warningNoJob||"No job selected!");return}let e=document.querySelector("input#resume[type=file]"),r=document.querySelector("input#cover[type=file]"),u=k||_||Object.keys(S).length||i(f).find("#uploadExisting").is(":checked");if(i(f).find(".fcLoader").addClass("fcLoadingSeek"),l.store("previousApplicationPage",null),!c.isValid){w("hide"),alert(t.config.warningQuestions||"Please complete all of the screening questions"),i(f).find(".fcLoader").removeClass("fcLoadingSeek");return}if(t.config.requireApproval===!0&&!i(f).find("[data-rel=field-approve]").is(":checked")){w("hide"),alert(t.config.approvalWarning||"Please confirm approval of the terms"),i(f).find(".fcLoader").removeClass("fcLoadingSeek");return}let d=(g,p)=>(p==null?void 0:p.length)>0&&p||(g==null?void 0:g.length)>0&&g||"",b=i(f).find("input.invalid").map((g,p)=>`- ${d(i(p).attr("data-name"),i(p).attr("placeholder"))}`).toArray();if(b.length>0){w("hide"),alert(`${t.config.warningValidation||"Please correct the following:"}
${b.join(`
`)}`),i(f).find(".fcLoader").removeClass("fcLoadingSeek");return}c.answers().then(g=>{let p=c.knockout(g);if((p==null?void 0:p.length)>0){s.config().then(O=>{p.forEach(m=>{var Q,h,L;let I=(Q=O==null?void 0:O.knockout)==null?void 0:Q.find($=>$.screeningQuestionID===m.screeningQuestionID);if(((h=I==null?void 0:I.alert)==null?void 0:h.length)>0&&alert(I.alert),((L=I==null?void 0:I.redirect)==null?void 0:L.length)>0){let $=t.inEditor?`/site/${C}${I.redirect}?preview=true&insitepreview=true&dm_device=desktop`:I.redirect;window.location=$}})}),i(f).find(".fcLoader").removeClass("fcLoadingSeek");return}let v=O=>{var I,Q;let m=n();return G(m)?k&&!m.cVFileContent?(w("hide"),alert(t.config.warningResume||"Please upload your resume"),i(f).find(".fcLoader").removeClass("fcLoadingSeek"),Promise.reject()):(m.cVFileContent=(I=m.cVFileContent)!=null?I:O.candidate.cVFileContent,m.cVFileName=(Q=m.cVFileName)!=null?Q:O.candidate.cVFileName,m.phone=m.phone||O.candidate.phone||null,m.mobile=m.mobile||O.candidate.mobile||null,delete m.dudaSiteID,delete m.defaultPhoneCountry,delete m.validatePhone,l.submit({action:"Edit Candidate Info",...O.candidate,...m}).then(h=>h.status&&l.user(!0)||Promise.reject())):(w("hide"),alert(t.config.warningFields||"Please complete all required fields"),i(f).find(".fcLoader").removeClass("fcLoadingSeek"),Promise.reject())},y=O=>{var K,X,ee,ne,ie;let m={referralSource:F.searchParams.get("utm_source")||l.session("referralSource"),referralMedium:F.searchParams.get("utm_medium")||l.session("referralMedium"),referralTerm:F.searchParams.get("utm_term")||l.session("referralTerm"),referralCampaign:F.searchParams.get("utm_campaign")||l.session("referralCampaign"),referralContent:F.searchParams.get("utm_content")||l.session("referralContent")},I={jobID:x(),screeningAnswers:g,...m};if(u){if(i("#uploadExisting").is(":checked")&&((K=O==null?void 0:O.candidate)!=null&&K.cVFileContent))I.resumeFile=(X=O==null?void 0:O.candidate)==null?void 0:X.cVFileContent,I.resumeFileName=(ee=O==null?void 0:O.candidate)==null?void 0:ee.cVFileName;else try{let T=W(e,k,"resume");I.resumeFile=T&&btoa(S.resumeFile),I.resumeFileName=T&&S.resumeName,I.resumeUpdatedOn=T&&new Date}catch(T){i(f).find(".fcLoader").removeClass("fcLoadingSeek");return}try{let T=W(r,_,"coverLetter");I.coverLetterFile=T&&btoa(S.coverLetterFile),I.coverLetterFileName=T&&S.coverLetterFileName,I.coverLetterUpdatedOn=T&&new Date}catch(T){i(f).find(".fcLoader").removeClass("fcLoadingSeek");return}if(e&&k&&!I.resumeFile){alert(t.config.warningResume||"Please upload your resume");return}if(r&&_&&!I.coverLetterFile){alert(t.config.warningCoverLetter||`Please upload your cover letter, or tick the "I don't have cover letter"`);return}}t.config.showGender&&(I.customField1=i("#gender").val()),t.config.showAboriginal&&(I.customField2=i("#aboriginal").is(":checked")),t.config.enableTracing&&(I.session=l.uuid(),s.log("apply",{candidate:O,application:I}));let Q;try{Q=JSON.parse(l.store("currentJobViewed"))}catch(T){}let h,L=(ne=Q==null?void 0:Q.data)==null?void 0:ne.applicationURL;if((L==null?void 0:L.length)>0)h=L;else if(h=`/${E}`,t.config.includeLastSearch&&(Q!=null&&Q.data)){let T=[];(t.config.redirectJobField||[]).forEach(te=>{let R=Q.data[te.field];(R==null?void 0:R.length)>0&&T.push(`${te.field}=${encodeURIComponent(R)}`)}),T.length&&(h=`/${E}?${T.join("&")}`)}let $={action:"Apply Job",dudaSiteID:t.siteId,application:I,candidate:O};if(I.resumeFile||I.coverLetterFile){l.submit($).then(()=>{w("stop"),A.clearKeys(),window.location.href=h}).catch(()=>{w("hide"),alert(t.config.warningApply||"Sorry, your application could not be submitted. Please try again."),i(f).find(".fcLoader").removeClass("fcLoadingSeek")});return}let be=((ie=l._site)==null?void 0:ie.RegionalUrl)||"https://shazamme.io/Job-Listing/src/php/regional/actions";try{fetch(be,{method:"POST",keepalive:!0,headers:{"Content-Type":"application/x-www-form-urlencoded; charset=UTF-8"},body:JSON.stringify($)})}catch(T){}w("stop"),A.clearKeys(),window.location.href=h},P=n();if(!G(P)){w("hide"),alert(t.config.warningFields||"Please complete all required fields"),i(f).find(".fcLoader").removeClass("fcLoadingSeek");return}if(k&&!P.cVFileContent){w("hide"),alert(t.config.warningResume||"Please upload your resume"),i(f).find(".fcLoader").removeClass("fcLoadingSeek");return}P.candidateID=l.uuid(),y(P)})}),i(f).find(".eye").on("click",function(){i(this).toggleClass("fa-eye-slash").toggleClass("fa-eye").siblings("input").attr("type",function(r,u){return u==="text"?"password":"text"})}),t.config.validatePhoneNumber&&typeof libphonenumber=="object"&&i(f).find("input[type=telephone]").on("change",function(){let e=i(this);if(e.removeClass("invalid"),e.val().trim().length!==0)try{let r=libphonenumber.parsePhoneNumber(e.val(),t.config.defaultPhoneCountry||"AU");!r.country||!r.isValid()?e.addClass("invalid"):e.val(r.formatInternational())}catch(r){e.addClass("invalid")}}),l.store("applicationURL",window.location.href),l.store("jobID",x()),l.site().then(e=>l.fetch({path:`/job-results/${e.siteID}/${x()}`,isExternal:!0,useCache:!0})).then(e=>{e!=null&&e.data?(l.store("currentJobViewed",JSON.stringify(e)),e.data.jobID===t.config.jobID&&s.pub("job-application-fixed-job",e.data.jobID,!0)):t.inEditor||(i(".shmApplicationMainContainer").hide(),i(".section-no-job-message").show())});let o=e=>{if(e!=null&&e.isNew){J({salutation:" ",firstName:e.firstName,surname:e.lastName,eMail:e.email,phone:"",mobile:"",isNew:!0});return}let r=e==null?void 0:e.candidate;J(r),r!=null&&r.candidateID&&fe(r.candidateID).then(u=>{if(u)if(confirm(t.config.duplicateWarning||"DUPLICATE WARNING MESSAGE")){let d=window.location.href.includes(C)?`/site/${C}/${j}?preview=true&insitepreview=true&dm_device=desktop`:`/${j}`;window.location.href=d}else window.location.reload()})};l.user().then(e=>{o(e)}),s.sub("site-auth",e=>{o(e)})};i("head").append(i('<link rel="stylesheet" type="text/css" href="https://sdk.shazamme.io/css/fontawesome/css/fontawesome.min.css" crossorigin="anonymous" />')).append(i('<link rel="stylesheet" type="text/css" href="https://sdk.shazamme.io/css/fontawesome/css/regular.min.css" crossorigin="anonymous" />')),window.__shazLoadScript("https://sdk.shazamme.io/js/shazamme-1.0.3.min.js").then(function(){Promise.all([l.ready(t.siteId,t.page),l.script("https://sdk.shazamme.io/js/plugin/libphonenumber/1.10.54/plugin.min.js")]).then(()=>{le(l.register("application-screening-form",t,!0))})})}return Oe(Te);})();
(function(){
