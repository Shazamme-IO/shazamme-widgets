 ...
 * Build aa15d406d432. Registers window.ShazammeWidget["<name>"].
 */
(function(){
...
var __shazWidgetExport = (() => {
  ...
  // widgets/job-results-v2/index.ts
  var index_exports = {};
  ...
  // widgets/job-results-v2/cards.ts
  ...
  // widgets/job-results-v2/paging.ts
  var MAX_VISIBLE = 5;
  ...
  // widgets/job-results-v2/facets.ts
  var MASTER_LEVELS = [
    { field: "jobTypeID", labelKey: "jobType", idKey: "jobTypeID" },
    { field: "professionID", labelKey: "category", idKey: "professionID", seoKey: "professionSeo", parentField: "jobTypeID" },
    { field: "roleID", labelKey: "subCategory", idKey: "roleID", seoKey: "roleSeo", parentField: "professionID" },
  ...
  // widgets/job-results-v2/map-view.ts
  ...
  // widgets/job-results-v2/state.ts
...
(function(){
  ...
  if (typeof window !== 'undefined') {
    ...
    window.ShazammeWidget["job-results-v2"] = controller;
